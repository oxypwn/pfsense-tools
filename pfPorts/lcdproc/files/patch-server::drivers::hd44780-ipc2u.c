--- server/drivers/hd44780-ipc2u.c.orig	Sun Jun  3 16:23:04 2007
+++ server/drivers/hd44780-ipc2u.c	Sun Jun  3 17:21:20 2007
@@ -0,0 +1,208 @@
+/*
+ * "IPC2U" 8-bit driver module for Hitachi HD44780 based LCD displays.
...
+// HD44780_readkeypad
+
+void lcdipc2u_HD44780_senddata(PrivateData *p, unsigned char displayID, unsigned char flags, unsigned char ch);
+void lcdipc2u_HD44780_backlight(PrivateData *p, unsigned char state);
+unsigned char lcdipc2u_HD44780_readkeypad(PrivateData *p, unsigned int YData);
+void lcdipc2u_HD44780_output(PrivateData *p, int data);
+
+#define EN1	LF
+#define EN2	0x00
+#define EN3	0x00
...
+
+	hd44780_functions->senddata = lcdipc2u_HD44780_senddata;
+	hd44780_functions->backlight = lcdipc2u_HD44780_backlight;
+	hd44780_functions->readkeypad = lcdipc2u_HD44780_readkeypad;
+
...
+		p->stuckinputs = lcdipc2u_HD44780_readkeypad(p, 0);
+	}
+
+	// Write new value to output port latches
+	hd44780_functions->output = lcdipc2u_HD44780_output;
+
+	return 0;
+}
+
+// lcdipc2u_HD44780_senddata
+void
+lcdipc2u_HD44780_senddata(PrivateData *p, unsigned char displayID, unsigned char flags, unsigned char ch)
+{
