...
export SRCDIR=${SRCDIR:-/usr/FreeBSDsrc/src}
...
export pfSense_version=${pfSense_version:-"9"}
export FREEBSD_VERSION=${FREEBSD_VERSION:-"9"}
export FREEBSD_BRANCH=${FREEBSD_BRANCH:-"RELENG_9_0"}
...
#export custom_overlay="${BUILDER_PROFILES}/freebsd_only/custom_overlay/"
