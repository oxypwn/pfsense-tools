...
export ISOPATH=${ISOPATH:-${MAKEOBJDIRPREFIX}/pfPBX.iso}
export IMGPATH=${IMGPATH:-${MAKEOBJDIRPREFIX}/pfPBX.img}
...
export CUSTOM_REMOVE_LIST="${BUILDER_PROFILES}/pfPBX/remove.list"
export CUSTOM_COPY_LIST="${BUILDER_PROFILES}/pfPBX/copy.list"

# Use a custom config.xml
export USE_CONFIG_XML=${USE_CONFIG_XML:-"${BUILDER_PROFILES}/pfPBX/config/config.xml"}
