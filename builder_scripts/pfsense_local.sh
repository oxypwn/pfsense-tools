...
if [ ${FREEBSD_VERSION} -ge 10 ]; then
	export MODULES_OVERRIDE=${MODULES_OVERRIDE:-"i2c ipmi acpi ndis ipfw ipdivert dummynet fdescfs cpufreq opensolaris zfs glxsb if_stf virtio coretemp amdtemp aesni sfxge mps ahci vmware"}
