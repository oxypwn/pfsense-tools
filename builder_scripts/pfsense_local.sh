...
export GIT_REPO=${GIT_REPO:-"https://github.com/bsdperimeter/pfsense.git"}
...
export 
ISOPATH=${ISOPATH:-${MAKEOBJDIRPREFIXFINAL}/${PRODUCT_NAME}-LiveCD-${PFSENSE_VERSION}-${ARCH}-`date '+%Y%m%d-%H%M'`.iso}
